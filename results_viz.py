...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .site-header .site-title {{ min-width: 0; }}
  .site-header .site-title-name {{
    font-size: 24px; color: var(--accent); font-weight: 600; line-height: 1.2;
  }}
  .site-header .site-title-tagline {{
    margin-top: 4px; color: #5b6574; font-size: 14px; line-height: 1.4;
  }}
  @media (max-width: 600px) {{
    .site-header {{ flex-wrap: wrap; gap: 10px; }}
    .site-header .site-logo {{ height: 112px; }}
  }}
  h1 {{
...
<header class="site-header">
  <a href="./index.html" class="site-logo-link"><img src="./img/isohyet_logo.png" alt="Isohyet Optimizer" class="site-logo"></a>
  <div class="site-title">
    <div class="site-title-name">Frequency-Flow Isohyet Optimizer</div>
    <div class="site-title-tagline">A hybrid Atlas&nbsp;14 / HMR&nbsp;52 design-storm method for iterating peak target flow at a watershed outfall.</div>
  </div>
</header>
